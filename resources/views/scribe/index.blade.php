...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    ...
                    <ul id="tocify-header-contractors" class="tocify-header">
                <li class="tocify-item level-1" data-unique="contractors">
                    <a href="#contractors">Contractors</a>
                </li>
                                    <ul id="tocify-subheader-contractors" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="contractors-GETapi-contragents">
                                <a href="#contractors-GETapi-contragents">Get a list of contractors</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="uer">
                    <a href="#uer">Uer</a>
                </li>
                                    <ul id="tocify-subheader-uer" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="uer-GETapi-me">
                                <a href="#uer-GETapi-me">Get the authenticated user</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This endpoint allows users to create an account by providing their name, email, and password.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The full name of the user. Max: 255 characters. Example: <code>"John Doe"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>A valid and unique email address. Max: 255 characters. Example: <code>"john@example.com"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>A password with at least 8 characters. Must be confirmed. Example: <code>"password123"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>This endpoint allows users to log in using their email and password.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>A registered email address. Max: 255 characters. Example: <code>"john@example.com"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>The user's password. Example: <code>"password123"</code></p>
                ...
                <h1 id="contractors">Contractors</h1>

    

                                <h2 id="contractors-GETapi-contragents">Get a list of contractors</h2>

<p>
</p>

<p>This endpoint retrieves a paginated list of contractors along with their associated users.</p>

<span id="example-requests-GETapi-contragents">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/contragents?per_page=20" \
    --header "Content-Type: application/json" \
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/contragents"
);
...
<span id="example-responses-GETapi-contragents">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-contragents" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-contragents"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-contragents"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-contragents" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-contragents">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-contragents" data-method="GET"
      data-path="api/contragents"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-contragents', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-contragents"
                    onclick="tryItOut('GETapi-contragents');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-contragents"
                    onclick="cancelTryOut('GETapi-contragents');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-contragents"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-contragents"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-contragents"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
               ...
               step="any"               name="per_page"                data-endpoint="GETapi-contragents"
               value="20"
               data-component="query">
    <br>
<p>The number of results per page. Defaults to 15. Example: <code>20</code></p>
            </div>
                </form>

                    <h2 id="contractors-POSTapi-contragents">Create a new contractor</h2>

<p>
</p>

<p>This endpoint allows creating a new contractor by providing an INN, address, name, and a user ID.</p>

<span id="example-requests-POSTapi-contragents">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-contragents">
            <blockquote>
            <p>Example response (201):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-contragents" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-contragents"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-contragents"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-contragents" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-contragents">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-contragents" data-method="POST"
      data-path="api/contragents"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-contragents', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-contragents"
                    onclick="tryItOut('POSTapi-contragents');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-contragents"
                    onclick="cancelTryOut('POSTapi-contragents');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-contragents"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-contragents"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-contragents"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="inn"                data-endpoint="POSTapi-contragents"
               value=""7707083893""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="address"                data-endpoint="POSTapi-contragents"
               value=""123 Main St, Moscow""
               data-component="body">
    <br>
<p>optional The address of the contractor. Example: <code>"123 Main St, Moscow"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-contragents"
               value=""ООО Контрагент""
               data-component="body">
    <br>
...
<p>The ID of the user to associate with the contractor. Example: <code>2</code></p>
                ...
                <h1 id="uer">Uer</h1>
                                ...
                                <h2 id="uer-GETapi-me">Get the authenticated user</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint retrieves the currently authenticated user's information.</p>
